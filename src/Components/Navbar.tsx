        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex flex-grow justify-center">
            <div className="flex items-baseline space-x-4">
              ...
              <Link
                to={"/user/services"}  // Added a to prop
                className="text-gray-600 hover:bg-gray-100 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium"
              >
                Services
              </Link>
              <Link
                to={"/user/contact"}  // Added a to prop
                className="text-gray-600 hover:bg-gray-100 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium"
              >
                Contact
              </Link>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <button
              className="mt-1 w-full bg-red-500 hover:bg-red-600 text-white px-3 py-2 rounded-md text-base font-medium"
              onClick={handleLogout}
            >
              Logout
            </button>
